...
class DataDecryption():
    ...
    def lab_multiplication(self):
        with open(path + '\\Public_Key\\public_key', 'rb') as public_key_file:
          public_key = pickle.load(public_key_file)
          
        with open(path + '\\CSP\\private_key', 'rb') as private_key_file:
          private_key = pickle.load(private_key_file)
        with open(path + '\\CSP\\lab_multiply_ciphers', 'rb') as AS_multiply_file:
        ...
        with open(path + '\\AS\\return_cipher_CSP', 'wb') as return_cipher_CSP_file:
    ...
    def group_by_count_encoded(self):
        ...
        with open(path + '\\CSP\\private_key', 'rb') as private_key_file:
            private_key = pickle.load(private_key_file)
        with open(path + '\\CSP\\data_set_size.txt','r') as data_set_size_file:
        ...
        with open(path + '\\AS\\gbce_return_vector_CSP', 'wb') as gbce_return_vector_file:
